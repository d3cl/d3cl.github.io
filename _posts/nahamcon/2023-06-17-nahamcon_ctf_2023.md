...
tags: [local-file-inclusion, server-side-request-forgery, css-injection, os-command-injection, server-side-template-injection, privilege-escalation, date, private-key]
